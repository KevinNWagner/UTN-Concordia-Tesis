          ...
          <li class="header"></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/administracion/cartelera"><i class="fa fa-circle-o"></i> Carteleras</a></li>
                <li><a href="/administracion/cronograma"><i class="fa fa-circle-o"></i> Cronogramas</a></li>
              </ul>
            </li>
            ...
            <li>
              <a href="/administracion/colectivo">
